...
file_x_train = np.load('/home/users/datasets/EEICA/UTFPR-BOP-splits-species/X_train.npy')[0:1000] ####################### retirar [0:1000] para usar todos os dados #######################
y_train  = np.load('/home/users/datasets/EEICA/UTFPR-BOP-splits-species/y_train.npy')[0:1000]  ####################### retirar [0:1000] para usar todos os dados #######################
