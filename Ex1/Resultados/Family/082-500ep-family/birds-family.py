...
def plot_losses(history, output_path):
        ...
        plt.savefig(output_path + 'loss_plot-family.png', dpi = 300)
        plt.close()
                                                                                                   ####################### le apenas os primeiros mil dados de cada conjunto ###############     
file_x_train = np.load('/home/users/datasets/EEICA/UTFPR-BOP-splits/X_train.npy') ####################### retirar [0:1000] para usar todos os dados #######################
y_train  = np.load('/home/users/datasets/EEICA/UTFPR-BOP-splits/y_train.npy')  ####################### retirar [0:1000] para usar todos os dados #######################
...
file_x_test  = np.load('/home/users/datasets/EEICA/UTFPR-BOP-splits/X_test.npy')  ####################### retirar [0:1000] para usar todos os dados #######################
...
predictions = model.predict_generator(test_generator, 6)
#predictions = model.predict(X_test)


predictions = np.argmax(predictions, axis = 1)

output_csv = open('/home/users/lucas/EEICA/Ex1/output_sample_family.csv', 'w')
