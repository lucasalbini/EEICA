...
history = model.fit(X_train, y_train, validation_split=0.25, batch_size=128, epochs=100, shuffle = True)
predictions = model.predict(X_test)

predictions = np.argmax(predictions, axis = 1)

output_csv = open('/home/users/lucas/EEICA/Ex1/output_sample.csv', 'w')
